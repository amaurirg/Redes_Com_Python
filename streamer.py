# coding: utf-8
#!/usr/bin/env python3
# Simplesmente envie todos os dados e feche a conexão
# Cliente que envia dados e fecha o soquete sem esperar uma resposta
...
def server(address):
    ...
    message = b''
    while True:
        more = sc.recv(8192)    # valor arbitrário de 8k
        print('Mensagem:', more)
        if not more:            # se recv() retornar '' é porque o soquete foi fechado
