#!/usr/bin/env python3
# Delimitando cada bloco precedendo-o com seu tamanho
# Enviando dados por fluxo, mas delimitados como blocos prefixados com o tamanho.

import socket, struct
from argparse import ArgumentParser


header_struct = struct.Struct('!I') # mensagens com tamanho até 2**32 - 1
...
def server(address):
    ...
    sock.bind(address)
    sock.listen(1)
    print('Run this script in another window "-c" to connect')
